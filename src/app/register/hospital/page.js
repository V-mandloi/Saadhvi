...
export default function RegisterHospitalPage() {
  const [formData, setFormData] = useState({ role: 'Hospital' });
    ...
    <Container className="d-flex align-items-center justify-content-center" style={{ minHeight: '100vh' }}>
      <Card className="shadow-lg" style={{ width: '28rem' }}>
        <Card.Body className="p-5">
          <h2 className="fw-bold mb-4 text-center">Register as a Hospital</h2>
          <Form onSubmit={handleSubmit}>
            ...
            <Form.Group className="mb-3">
              ...
              <Form.Control type="text" name="registrationNumber" onChange={handleChange} required />
            </Form.Group>
            <Form.Group className="mb-3">
